...
# %% auto 0
__all__ = ['T', 'PAST_RETURN_COLS', 'RVOL_COLS', 'ORIGINAL_CONT_COLS', 'UNSCALED_CONT_COLS', 'SCALED_CONT_COLS', 'MARKET_DIM',
           'TIME_DIM', 'CONTEXT_DIM', 'calibrate_rescale_factor', 'build_quantile_map', 'apply_quantile_map',
           'sample_residuals', 'generate_path_ensemble_garch', 'evaluate_predictive_risk', 'plot_pit_histogram',
           'plot_var_timeseries']
...
def calibrate_rescale_factor(condition_df, model, alphas, betas, scaler_x,
                               ...
                               train_size=0.80, n_calib=2000,scaled_cont_cols=SCALED_CONT_COLS,
    unscaled_cont_cols=UNSCALED_CONT_COLS,T=T,guidance_scale=1.5, temperature=1.0):
...
def sample_residuals(condition_row, n_samples, model, alphas, betas,
                      ...
                      guidance_scale=1.5, alphas_bar_in=None,scaled_cont_cols=SCALED_CONT_COLS,
                      unscaled_cont_cols=UNSCALED_CONT_COLS,T=T,temperature=1.0):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
